...
def parse_args():
    ...
    parser.add_argument('--mode',default='NoBRS', choices=['NoBRS', 'RGB-BRS', 'DistMap-BRS',
                                         'f-BRS-A', 'f-BRS-B', 'f-BRS-C'],
                        help='')

    group_checkpoints = parser.add_mutually_exclusive_group(required=False)
    group_checkpoints.add_argument('--checkpoint', type=str, default='experiments/iter_mask/cocolvis_plainvit_base448/021_cocolvis_plainvit_base448/checkpoints/last_checkpoint.pth',
    ...
    parser.add_argument('--datasets', type=str, default='GrabCut,Berkeley,DAVIS,SBD',
    ...
    parser.add_argument('--save-ious', action='store_true', default=True)
    parser.add_argument('--print-ious', action='store_true', default=True)
