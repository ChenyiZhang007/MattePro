...
def build_sam2(
    ...
    model = instantiate(cfg.model, _recursive_=True)# click
    ...
    if bbox_mask_matting_token:
        for n, p in model.named_parameters():
            # if 'iloveapex' in n :
            if 'matting' in n or 'bbox_mask' in n or 'sam_prompt_encoder' in n or 'mask_decoder' in n:
            # if 'matting' in n or 'bbox_mask' in n or 'point_embeddings' in n or 'not_a_point_embed' in n:    
