...
train.init_checkpoint = '/opt/data/private/lyh/Efficient_Matting/ViT_based/ViTMatte_topk_eff/pretrained/dino_vit_s_fna.pth'
train.output_dir = './output_of_train/MixData_ViTMatte_S_topk0.25_1024'
